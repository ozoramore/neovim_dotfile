...
hi('LineNumberGroup1', colors.yellow, nil)
hi('LineNumberGroup2', colors.b_red, nil)
hi('LineNumberGroup3', colors.red, nil)
hi('LineNumberGroup4', colors.magenta, nil)
hi('LineNumberGroup5', colors.blue, nil)
