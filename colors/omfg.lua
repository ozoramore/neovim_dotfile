...
hi('TabLineFill', nil, nil, { undercurl = false })
hi('TabLineSel', colors.b_white, nil, { undercurl = true })
...
hi('Folded', colors.white, nil, { undercurl = true })
hi('LineNr', colors.b_yellow, nil, { bold = false })
hi('MatchParen', nil, nil, { undercurl = true })
