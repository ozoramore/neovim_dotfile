...
hi('LineNumberGroup1', nil, nil, { sp = colors.highlight, underline = true })
hi('LineNumberGroup2', nil, nil, { sp = colors.b_red, underline = true })
hi('LineNumberGroup3', colors.cyan, nil)
hi('LineNumberGroup4', colors.b_green, nil)
hi('LineNumberGroup5', nil, nil, { sp = colors.cyan, underline = true })
