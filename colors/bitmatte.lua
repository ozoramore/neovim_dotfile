vim.cmd.hi('clear')
vim.g.colors_name = 'bitmatte'
local colors = {
	black     = { active = { gui = '#17181a', cli = 'Black' }, inactive = { gui = '#101010', cli = 'Black' } },
	red       = { active = { gui = '#d95136', cli = 'DarkRed' }, inactive = { gui = '#808080', cli = 'DarkGrey' } },
	green     = { active = { gui = '#51966c', cli = 'DarkGreen' }, inactive = { gui = '#707070', cli = 'DarkGrey' } },
	yellow    = { active = { gui = '#d9a336', cli = 'DarkYellow' }, inactive = { gui = '#b0b0b0', cli = 'DarkGrey' } },
	blue      = { active = { gui = '#366cd9', cli = 'DarkBlue' }, inactive = { gui = '#505050', cli = 'DarkGrey' } },
	magenta   = { active = { gui = '#9589d9', cli = 'DarkMagenta' }, inactive = { gui = '#a0a0a0', cli = 'LightGrey' } },
	cyan      = { active = { gui = '#36bed9', cli = 'DarkCyan' }, inactive = { gui = '#b0b0b0', cli = 'LightGrey' } },
	white     = { active = { gui = '#dcdfe4', cli = 'LightGrey' }, inactive = { gui = '#d0d0d0', cli = 'LightGrey' } },
	b_black   = { active = { gui = '#5c5c6e', cli = 'DarkGrey' }, inactive = { gui = '#555555', cli = 'DarkGrey' } },
	b_red     = { active = { gui = '#ff9580', cli = 'LightRed' }, inactive = { gui = '#999999', cli = 'LightGrey' } },
	b_green   = { active = { gui = '#84cf98', cli = 'LightGreen' }, inactive = { gui = '#aaaaaa', cli = 'LightGrey' } },
	b_yellow  = { active = { gui = '#ffd480', cli = 'LightYellow' }, inactive = { gui = '#cccccc', cli = 'LightGrey' } },
	b_blue    = { active = { gui = '#80aaff', cli = 'LightBlue' }, inactive = { gui = '#666666', cli = 'DarkGrey' } },
	b_magenta = { active = { gui = '#d273e6', cli = 'LightMagenta' }, inactive = { gui = '#bbbbbb', cli = 'LightGrey' } },
	b_cyan    = { active = { gui = '#80eaff', cli = 'LightCyan' }, inactive = { gui = '#eeeeee', cli = 'LightGrey' } },
	b_white   = { active = { gui = '#ffffff', cli = 'White' }, inactive = { gui = '#ffffff', cli = 'White' } },

	tools     = { active = { gui = '#606066', cli = 'DarkGrey' }, inactive = { gui = '#666666', cli = 'DarkGrey' } },
	comment   = { active = { gui = '#a4bfb6', cli = 'LightGrey' }, inactive = { gui = '#aaaaaa', cli = 'LightGrey' } },
	highlight = { active = { gui = '#eecc77', cli = 'DarkYellow' }, inactive = { gui = '#606060', cli = 'DarkYellow' } },
	separator = { active = { gui = '#eecc77', cli = 'DarkYellow' }, inactive = { gui = '#eecc77', cli = 'DarkYellow' } },
}
...
local hi = function(name, fg, bg, sp)
	...
	vim.api.nvim_set_hl(active_window_ns, name, gen_val(true))
	vim.api.nvim_set_hl(inactive_window_ns, name, gen_val(false))
end
...
local function link(name, target)
	...
	vim.api.nvim_set_hl(active_window_ns, name, val)
	vim.api.nvim_set_hl(inactive_window_ns, name, val)
end
